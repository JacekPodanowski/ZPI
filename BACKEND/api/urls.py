...
urlpatterns = [
    ...
    # New unified legal document endpoints
    path('documents/<str:doc_type>/latest/', LatestDocumentView.as_view(), name='document-latest'),
    path('documents/<str:doc_type>/all/', AllDocumentsView.as_view(), name='document-all'),
    path('documents/<str:doc_type>/create/', CreateDocumentView.as_view(), name='document-create'),
    # Backwards compatible terms endpoints
